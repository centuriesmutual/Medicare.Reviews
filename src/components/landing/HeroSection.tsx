    ...
    <section className="site-section site-section--white" aria-labelledby="hero-heading">
      <div className="site-container">
        <div className="site-hero-grid">
          ...
          <aside id="start-earning" className="site-hero-sidebar site-box mt-10 scroll-mt-28 min-w-0 max-lg:max-w-xl lg:mt-0">
            ...
            <EmailSignupForm idPrefix="hero" sidebarLayout className="[&_input.nyt-input]:w-full" />
          </aside>
        </div>
      </div>
    </section>
